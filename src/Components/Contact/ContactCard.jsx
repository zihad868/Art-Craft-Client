...
const ContactCard = ({ craft }) => {
    console.log(craft)
    const {_id ,photo,address, contact, subCategoryName, email, shortDescription } = craft;
    return (
        <div className="">
            ...
            <div className="">
                ...
                <p> <span className="text-xl">Address:</span> {address}</p>
                <p> <span className="text-xl">Contact:</span> {contact}</p>
