        ...
        <div className="navbar">
          <div className="navbar-start">
            ...
            <div className="flex items-center justify-center">
              ...
              <a className="btn btn-ghost text-5xl text-green-800">Art<span className="text-">Craft</span></a>
            </div>
          </div>
          <div className="navbar-center hidden lg:flex">
            <ul className="menu menu-horizontal px-1 font-bold text-2xl text-white">
              {navLink}
            </ul>
          </div>
